...
// // const Hero = () => {
// //   return (
// //     <div className='flex justify-center items-center w-full border-2 border-green-700'>
// //       <div className='border-2 border-red-500 flex flex-col-reverse md:flex-row justify-center items-center gap-8 py-6 px-6 my-5 mx-[50px] w-full max-w-screen-xl'>
// //         {/* Left Section - Text & Buttons */}
// //         <div className='flex border-2  border-blue-500 flex-col py-5 px-6 w-full max-w-2xl gap-6 text-center md:text-left'>
// //           <h1 className='text-4xl md:text-5xl font-bold capitalize bg-gradient-to-r from-purple-800 to-blue-700 bg-clip-text text-transparent leading-tight'>
// //             Tokens & NFT with Ease
// //           </h1>
// //           <p className='font-medium text-lg max-w-xl'>
// //             Launch Token, Liquidity, Airdrops, and much more. Effortless and
// //             without coding.
// //           </p>
// //           <div className='flex flex-col md:flex-row items-center justify-center md:justify-start py-4 px-4 gap-4'>
// //             <Button className='text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center w-full md:w-auto'>
// //               Create Launch
// //             </Button>
// //             <Button className='text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center w-full md:w-auto'>
// //               Create Token
...
// //         {/* Right Section - Image */}
// //         <div className='border-2 flex border-yellow-500 w-full max-w-sm md:max-w-md'>
// //           <Image
// //             src='/solana.png'
// //             alt='Solana'
// //             width={400}
...
const Hero = () => {
  return (
    <section className='bg-white dark:bg-black md:px-16 '>
      <div className='py-12 px-6 mx-[50px] max-w-screen-lg text-center lg:py-16 lg:px-12 flex flex-col-reverse lg:flex-row items-center justify-center gap-12'>
        {/* Left Section: Text & Buttons */}
        <div className='w-full max-w-2xl flex flex-col items-center lg:items-start text-center lg:text-left'>
          <h1 className='text-4xl md:text-5xl font-extrabold tracking-tight leading-tight text-gray-900 dark:text-white capitalize'>
            Tokens & NFTs{" "}
          ...
          <div className='mt-6 flex flex-col sm:flex-row gap-4'>
            <Button className='text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800 rounded-lg px-6 py-3'>
              Lets Get Started
            </Button>
